...
package body Game_Board_Cell is
   ...
   procedure Add_Piece
     (Object : in out Cell_Class;
      Piece  :        Pieces.Piece_Class_Ptr) is
   begin
     ...
     (Object : in Cell_Class)
      ...
      procedure Visit_List_Node (Node : Pieces_List_Pkg.Cursor) is
         Piece : Pieces.Piece_Class_Ptr :=
           Pieces.Piece_Class_Ptr (Pieces_List_Pkg.Element (Node));
   ...
   begin
      ...
      if Object.Piece_List.Length > 0 then
         ...
         loop
            ...
            exit when Found or else Object.Piece_List.Last = Search_Cursor;
   ...
   function Board_Location
     (Object : Cell_Class)
      return Location.Location_Class is
   begin
